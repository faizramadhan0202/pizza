                                ...
                                <form action="" method="">
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <p>Small Pizza : <input type="text" class="form-control" name="small_pizza"></p>
                                            <p>medium Pizza : <input type="text" class="form-control" name="medium_pizza"></p>
                                            <p>large Pizza : <input type="text" class="form-control" name="large_pizza"></p>
                                            <p>
